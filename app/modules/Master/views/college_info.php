...
<div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
    <div>
        <h1 style="font-size: 1.5rem; font-weight: 800; color: var(--text-primary); margin: 0; display: flex; align-items: center; gap: 0.625rem;">
            <span>🏛️</span> Institution Master Profile
        </h1>
    ...
    <div>
        <span class="badge badge-success" style="font-size: 0.8125rem; padding: 0.5rem 1rem;">Verified Campus &bull; ESTD 2001</span>
    </div>
</div>
...
<div class="card" style="margin-bottom: 1.75rem; border-top: 4px solid var(--accent-color);">
    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1.5rem;">
        <div style="display: flex; align-items: center; gap: 1.25rem;">
            <div style="width: 64px; height: 64px; border-radius: 16px; background: rgba(2, 132, 199, 0.12); color: var(--accent-color); display: flex; align-items: center; justify-content: center; font-size: 2.25rem; font-weight: 800; border: 1px solid var(--border-color);">
                🏫
            </div>
            <div>
                <h2 style="font-size: 1.35rem; font-weight: 800; color: var(--text-primary); margin: 0; display: flex; align-items: center; gap: 0.5rem;">
        ...
        <div style="display: flex; align-items: center; gap: 1rem;">
            <div style="text-align: right;">
                <div style="font-size: 0.75rem; color: var(--text-secondary); text-transform: uppercase; font-weight: 700;">Official Support Email</div>
...
<div class="card">
    <h2 style="font-size: 1.125rem; font-weight: 800; color: var(--text-primary); margin-top: 0; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 0.5rem;">
        <span>⚙️</span> Official Campus Setup Form
    </h2>
    ...
    <form method="POST" action="/master/colleges">
        ...
        <div style="background: var(--bg-main); padding: 1.25rem; border-radius: 12px; border: 1px solid var(--border-color); margin-bottom: 1.5rem;">
            <h3 style="font-size: 0.9375rem; font-weight: 800; color: var(--accent-color); margin-top: 0; margin-bottom: 1rem; text-transform: uppercase; letter-spacing: 0.05em; display: flex; align-items: center; gap: 0.5rem;">
                <span>📌</span> 1. General Institution Information
            </h3>
        ...
        <div style="background: var(--bg-main); padding: 1.25rem; border-radius: 12px; border: 1px solid var(--border-color); margin-bottom: 1.5rem;">
            <h3 style="font-size: 0.9375rem; font-weight: 800; color: var(--accent-color); margin-top: 0; margin-bottom: 1rem; text-transform: uppercase; letter-spacing: 0.05em; display: flex; align-items: center; gap: 0.5rem;">
                <span>🎓</span> 2. Affiliation & Registration
            </h3>
        ...
        <div style="background: var(--bg-main); padding: 1.25rem; border-radius: 12px; border: 1px solid var(--border-color); margin-bottom: 1.5rem;">
            <h3 style="font-size: 0.9375rem; font-weight: 800; color: var(--accent-color); margin-top: 0; margin-bottom: 1rem; text-transform: uppercase; letter-spacing: 0.05em; display: flex; align-items: center; gap: 0.5rem;">
                <span>📍</span> 3. Campus Location & Permanent Address
            </h3>
        ...
        <div style="text-align: right; border-top: 1px solid var(--border-color); padding-top: 1.25rem;">
            <button type="submit" class="btn-primary" style="padding: 0.875rem 3rem; font-size: 0.9375rem;">Save Institutional Profile</button>
        </div>
    </form>
</div>
