...
<?php elseif ($role === 'head_of_coe'): ?>
    <!-- COE Control Center Grid -->
    <div class="dashboard-grid-2">
        <!-- Left: Action center -->
        <div class="card">
            <h2 style="font-size: 1.125rem; font-weight: 700; color: var(--text-primary); margin-top: 0; margin-bottom: 1.25rem; display: flex; align-items: center; gap: 0.5rem;">
                <span>⚙️</span> COE Examination Control Center
            </h2>
            <p class="text-muted mb-4" style="font-size: 0.8125rem;">Use these quick links to manage scheduling, student approvals, and processing results.</p>

            <div style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
                <a href="/timetable" style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.2); padding: 1.25rem; border-radius: var(--border-radius); text-decoration: none; display: flex; align-items: center; justify-content: space-between; color: var(--text-primary); font-weight: 600;">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <span style="font-size: 1.5rem;">🗓️</span>
                        <div>
                            <div style="font-size: 0.875rem; font-weight: 700;">Configure Examination Timetable</div>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 400; margin-top: 0.15rem;">Schedule subjects, date, time slots, and rooms</div>
                        </div>
                    </div>
                    <span>&rarr;</span>
                </a>

                <a href="/admit-cards/manage" style="background: rgba(2, 132, 199, 0.1); border: 1px solid rgba(2, 132, 199, 0.2); padding: 1.25rem; border-radius: var(--border-radius); text-decoration: none; display: flex; align-items: center; justify-content: space-between; color: var(--text-primary); font-weight: 600;">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <span style="font-size: 1.5rem;">🎫</span>
                        <div>
                            <div style="font-size: 0.875rem; font-weight: 700;">Manage Hall Tickets / Eligibility</div>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 400; margin-top: 0.15rem;">Generate hall tickets, block students with dues or grant condonation</div>
                        </div>
                    </div>
                    <span>&rarr;</span>
                </a>

                <a href="/results" style="background: rgba(168, 85, 247, 0.1); border: 1px solid rgba(168, 85, 247, 0.2); padding: 1.25rem; border-radius: var(--border-radius); text-decoration: none; display: flex; align-items: center; justify-content: space-between; color: var(--text-primary); font-weight: 600;">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <span style="font-size: 1.5rem;">🏆</span>
                        <div>
                            <div style="font-size: 0.875rem; font-weight: 700;">Semester Results Engine</div>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 400; margin-top: 0.15rem;">Calculate SGPA/CGPA, process grades, and publish semester results</div>
                        </div>
                    </div>
                    <span>&rarr;</span>
                </a>
...
<?php elseif ($role === 'tpo'): ?>
    <!-- TPO Control Center Grid -->
    <div class="dashboard-grid-2">
        <!-- Left: Action center -->
        <div class="card">
            <h2 style="font-size: 1.125rem; font-weight: 700; color: var(--text-primary); margin-top: 0; margin-bottom: 1.25rem; display: flex; align-items: center; gap: 0.5rem;">
                <span>⚙️</span> TPO Placement & Training Control Center
            </h2>
            <p class="text-muted mb-4" style="font-size: 0.8125rem;">Use these quick links to manage recruitment drives, companies, and training logs.</p>

            <div style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
                <div style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.2); padding: 1.25rem; border-radius: var(--border-radius); display: flex; align-items: center; justify-content: space-between; color: var(--text-primary);">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <span style="font-size: 1.5rem;">💼</span>
                        <div>
                            <div style="font-size: 0.875rem; font-weight: 700;">Create & Manage Company Drives</div>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 400; margin-top: 0.15rem;">Set eligibility requirements (CGPA/backlogs) & schedule rounds</div>
                        </div>
                    </div>
                    <span class="badge badge-info" style="font-size: 0.6875rem; padding: 0.35rem 0.5rem;">Create Drive</span>
                </div>

                <div style="background: rgba(2, 132, 199, 0.1); border: 1px solid rgba(2, 132, 199, 0.2); padding: 1.25rem; border-radius: var(--border-radius); display: flex; align-items: center; justify-content: space-between; color: var(--text-primary);">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <span style="font-size: 1.5rem;">🏢</span>
                        <div>
                            <div style="font-size: 0.875rem; font-weight: 700;">Recruiter & Partner Database</div>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 400; margin-top: 0.15rem;">Maintain visiting companies, past visits, and packages</div>
                        </div>
                    </div>
                    <span class="badge badge-info" style="font-size: 0.6875rem; padding: 0.35rem 0.5rem;">Manage Partners</span>
                </div>

                <div style="background: rgba(168, 85, 247, 0.1); border: 1px solid rgba(168, 85, 247, 0.2); padding: 1.25rem; border-radius: var(--border-radius); display: flex; align-items: center; justify-content: space-between; color: var(--text-primary);">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <span style="font-size: 1.5rem;">👨‍🎓</span>
                        <div>
                            <div style="font-size: 0.875rem; font-weight: 700;">Student Placement Profiles</div>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 400; margin-top: 0.15rem;">Track applications, shortlists, offer letters, and join status</div>
                        </div>
                    </div>
                    <span class="badge badge-info" style="font-size: 0.6875rem; padding: 0.35rem 0.5rem;">Applications</span>
                </div>

                <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.2); padding: 1.25rem; border-radius: var(--border-radius); display: flex; align-items: center; justify-content: space-between; color: var(--text-primary);">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        <span style="font-size: 1.5rem;">📚</span>
                        <div>
                            <div style="font-size: 0.875rem; font-weight: 700;">Pre-Placement Training & Seminars</div>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 400; margin-top: 0.15rem;">Schedule aptitude classes, soft skills workshops, and mock tests</div>
                        </div>
                    </div>
                    <span class="badge badge-success" style="font-size: 0.6875rem; padding: 0.35rem 0.5rem;">Training Logs</span>
                </div>
            </div>
        </div>

        <!-- Right: Recruiter Feed & Student Announcements -->
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            <!-- Active Recruiter Partners -->
            <div class="card">
                <h2 style="font-size: 1.125rem; font-weight: 700; color: var(--text-primary); margin-top: 0; margin-bottom: 1.25rem; display: flex; align-items: center; gap: 0.5rem;">
                    <span>🏢</span> Active Hiring Partners
                </h2>
                <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                    <div style="background: var(--bg-main); padding: 0.75rem; border-radius: 8px; border: 1px solid var(--border-color); display: flex; align-items: center; justify-content: space-between;">
                        <div>
                            <strong style="font-size: 0.875rem; color: var(--text-primary);">Tata Consultancy Services (TCS)</strong>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); margin-top: 0.15rem;">Role: Systems Engineer &bull; CTC: ₹4.5 LPA</div>
                        </div>
                        <span class="badge badge-success">Active</span>
                    </div>
                    <div style="background: var(--bg-main); padding: 0.75rem; border-radius: 8px; border: 1px solid var(--border-color); display: flex; align-items: center; justify-content: space-between;">
                        <div>
                            <strong style="font-size: 0.875rem; color: var(--text-primary);">Infosys</strong>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); margin-top: 0.15rem;">Role: Specialist Programmer &bull; CTC: ₹9.5 LPA</div>
                        </div>
                        <span class="badge badge-success">Active</span>
                    </div>
                    <div style="background: var(--bg-main); padding: 0.75rem; border-radius: 8px; border: 1px solid var(--border-color); display: flex; align-items: center; justify-content: space-between;">
                        <div>
                            <strong style="font-size: 0.875rem; color: var(--text-primary);">Amazon</strong>
                            <div style="font-size: 0.75rem; color: var(--text-secondary); margin-top: 0.15rem;">Role: Support Engineer &bull; CTC: ₹18.5 LPA</div>
                        </div>
            ...
            <div class="card">
                ...
                <?php else: ?>
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <?php foreach (array_slice($ancList, 0, 2) as $anc): ?>
                            <div style="background: var(--bg-main); padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid var(--border-color);">
                                <h3 style="font-size: 0.875rem; font-weight: 700; color: var(--text-primary); margin: 0 0 0.25rem 0;"><?= e($anc['title']) ?></h3>
                                <p style="color: var(--text-secondary); font-size: 0.75rem; line-height: 1.4; margin: 0;">
                                    <?= e(mb_strimwidth($anc['content'], 0, 80, '...')) ?>
                                </p>
                            </div>
                        <?php endforeach; ?>
                    </div>
